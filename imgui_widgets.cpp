...
void ImGui::RenderKarma3DScene(void* karmaScene, ImVec4 bgColor)
{
    ImGuiWindow* window = GetCurrentWindow();
    ...
    //Scene* scene3D = static_cast<Scene*>(karmaScene);

    window->bUseCustomBgColor = true;
    window->BgColor = GetColorU32(bgColor);
}
