...
static void ShowExampleKeyPad(bool* p_open);
...
void ImGui::ShowDemoWindow(bool* p_open)
{
	...
	static bool show_application_khurpatal_demo = false;
	...
	if (show_application_khurpatal_demo) ShowExampleKeyPad(&show_application_khurpatal_demo);
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
			...
			ImGui::MenuItem("KhurPatal (FingerBorad)", NULL, &show_application_khurpatal_demo);
...
//-------------------------------------------------------------------------------------------------------------
// [SECTION] Example (mini) Application: Demonstration of keypad / ShowExampleKeyPad()
// credits: https://github.com/ocornut/imgui/issues/4066
//-------------------------------------------------------------------------------------------------------------
