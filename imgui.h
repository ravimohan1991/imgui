...
namespace ImGui
{
    //IMGUI_API struct ImGuiDockNode;
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, ImGuiWindow** theWindow = nullptr);
    IMGUI_API void          End();
    ...
    // Widgets: 3D Render for and by Karma
    // Long live FOSS and OSS!!
    // Classes
    IMGUI_API void          RenderKarma3DScene(void* karmaScene, ImVec4 bgColor); // Raw pointers, cause managing is done by Karma!
